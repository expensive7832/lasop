...
function CourseCard({ currentChrtOnline, currentChrtWeekDay, currentChrtWeekend  }) {
  ...
  useEffect(() =>{
    ...
    if(title == undefined){
      ...
      let info = data?.find((each) => each.dpt1 === title)
        ...
        <div className="row">
          <div className="col-md-5 col-12 d-flex justify-content-between align-items-center">
            ...
            <h6>  weekday</h6>
              ...
              <h4>
                  {new Date(currentChrtWeekDay).toLocaleString('default', { month: 'long' })} 
                  &nbsp; 
          ...
          <div className="col-md-5 col-12 d-flex justify-content-between align-items-center">
            <div className=''>
             <h6> weekend</h6>
              <h6 className='small'><BiCalendar /> Next cohort starts:</h6>
              <h4>
                  {new Date(currentChrtWeekend).toLocaleString('default', { month: 'long' })} 
                  &nbsp; 
          ...
          <div className="col-md-5 col-12 d-flex justify-content-between align-items-center">
            <div className=''>
             <h6> Online</h6>
              <h6 className='small'><BiCalendar /> Next cohort starts:</h6>
              <h4>
                  {new Date(currentChrtOnline).toLocaleString('default', { month: 'long' })} 
                  &nbsp; 
